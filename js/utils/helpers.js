...
/**
 * ИСПРАВЛЕННАЯ функция с DISCLAIMER
 */
        ...
        <div class="auth-container" style="max-width: 900px; width: 100%; max-height: 90vh; overflow-y: auto; border: 1px solid var(--gold); box-shadow: 0 0 50px rgba(255, 215, 0, 0.1); padding: 40px; background: #050505;">
            ...
            <div style="text-align: left; color: #ccc; line-height: 1.6; font-size: 0.95rem;">
                ...
                <div style="margin-bottom: 25px;">
                    ...
                    <p>Используя программное обеспечение <strong>Gold Options Pro v2</strong>, вы подтверждаете свое полное согласие с данными условиями.</p>
                </div>
                ...
                <div style="margin-bottom: 25px; padding: 20px; background: rgba(255, 23, 68, 0.1); border: 1px solid var(--put); border-radius: 8px;">
                    ...
                    <p style="margin-bottom: 15px;">
                        <strong>Данные предоставляются "как есть" с сайта CME (Чикагская товарная биржа).</strong> Мы не гарантируем их точность, полноту или своевременность. Использование этой информации для торговых решений осуществляется на ваш страх и риск.
                    </p>
                    <p style="margin-bottom: 15px;">
                        <strong>Авторы проекта не несут ответственности за любые убытки, возникшие в результате использования данных.</strong>
                    </p>
                    <p>
                        <strong>Все данные являются производными от публично доступной информации CME Group и не являются индивидуальной инвестиционной рекомендацией.</strong> Торговля опционами сопряжена с высоким риском потери капитала.
                    </p>
                </div>

                <div style="margin-bottom: 25px;">
                    <h3 style="color: #fff; margin-bottom: 10px;">3. ПОЛИТИКА КОНФИДЕНЦИАЛЬНОСТИ</h3>
                    <p>
                        Мы собираем только email адрес для регистрации и базовую информацию (IP, страна) для аналитики. <strong>Мы не продаем и не передаем ваши данные третьим лицам.</strong> Ваши данные хранятся в зашифрованном виде на серверах Firebase (Google).
                    </p>
                </div>

                <div style="margin-bottom: 25px;">
                    <h3 style="color: #fff; margin-bottom: 10px;">4. ИНФОРМАЦИЯ О ДАННЫХ</h3>
                    <p style="margin-bottom: 10px;">
                        <strong>Источник:</strong> CME Group (Чикагская товарная биржа)
                    </p>
                    <p style="margin-bottom: 10px;">
                        <strong>Частота обновления:</strong> Каждые 3 секунды для цены, каждые 3 минуты для аналитики
                    </p>
                    <p>
                        <strong>Примечание:</strong> Возможны технические задержки или неточности, вызванные сбоями на стороне биржи.
                    </p>
                </div>
